...
/*	base:seajs.baseHTTP+'/js/',*/
	alias: {
		...
		/*插件*/
		"selectordie"						:"dist/lib/selectordie/selectordie",
		"bootstrap-hover-dropdown"			:"dist/lib/bootstrap-hover-dropdown/bootstrap-hover-dropdown",
		"jquery-accordion-menu"				:"dist/lib/jquery-accordion-menu/jquery-accordion-menu",
		"jquery.bootstrap.newsbox"			:"dist/lib/jquery.bootstrap.newsbox/jquery.bootstrap.newsbox.min",
		"TweenMax"							:"dist/lib/TweenMax/TweenMax.min",
		"ScrollToPlugin"					:"dist/lib/ScrollToPlugin/ScrollToPlugin.min",
		"navMenu"					        :"dist/lib/navMenu/jq22",
		"viewer"					        :"dist/lib/viewer",
		/*view*/
		"view_index"						:"src/view/view_index",
		"view_channellist"					:"src/view/view_channellist",
		"view_newslist"					    :"src/view/view_newslist",
		"view_new"					  	    :"src/view/view_new",
		"view_search"						:"src/view/view_search",
		"view_showList"						:"src/view/view_showList",
		"view_more"						    :"src/view/view_more",
		/*service*/
		"S_core"                            :"src/service/service_core",
		"view_info"                              :"src/view/view_info",
		"view_quick"                              :"src/view/view_quick",
	},
	map: [
	      [ /^(.*\.(?:css|js|tpl))(.*)$/i, '$1?'+ new Date().getTime()]
	],
	vars: {
		'locale': 'zh-cn'
	},
...
/*
     FILE ARCHIVED ON 04:59:25 May 02, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:19:09 Jun 07, 2022.
...
/*
playback timings (ms):
  captures_list: 289.281
  exclusion.robots: 0.091
  exclusion.robots.policy: 0.084
  RedisCDXSource: 11.992
  esindex: 0.008
  LoadShardBlock: 262.239 (3)
  PetaboxLoader3.datanode: 199.593 (5)
  CDXLines.iter: 12.751 (3)
  PetaboxLoader3.resolve: 130.633 (2)
  load_resource: 124.453
  loaddict: 5.715
*/